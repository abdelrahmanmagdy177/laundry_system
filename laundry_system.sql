...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 29, 2024 at 03:04 PM
...
INSERT INTO `invoices` (`id`, `user_id`, `customer_name`, `room_number`, `is_modified`, `total`, `created_at`) VALUES
(1, 2, 'ahmed', 100, 0, 0, '2024-12-27 16:56:36');
...
CREATE TABLE `prices` (
  ...
  `opeartion_type_id` int(11) NOT NULL,
  `price` decimal(10,0) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `prices`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `opeartion_type` (`opeartion_type_id`),
...
ALTER TABLE `prices`
  ...
  ADD CONSTRAINT `prices_ibfk_2` FOREIGN KEY (`opeartion_type_id`) REFERENCES `operation_types` (`id`);
