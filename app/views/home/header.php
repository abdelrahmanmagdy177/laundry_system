  ...
  <a class="navbar-brand" href="#">
    ...
    <div class="collapse navbar-collapse navbar-parent" id="navbarExample3">
      ...
      <ul class="navbar-nav ms-lg-auto mb-2 mb-lg-0">
        <li class="nav-item">
            <a class="nav-link" href="<?= path?>home/index">الصفحه الرئيسية</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?= path?>home/contact_us">انشاء فاتورة</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?= path?>home/about_us"> مراجعه الفواتير</a>
        </li>
